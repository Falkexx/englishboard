...
interface Select_1_imageProps {
    lesson: Lesson;
    onComplete: () => void;
}

function Select_1_image({ lesson, onComplete }: Select_1_imageProps) {
